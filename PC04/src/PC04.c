...
// Email: cbae@nd.edu
// Credit: Main template developed by Professor Morrison
// File Contents: this program contains the main function for 
// Programming Challenge 04, where the calls are made
//
